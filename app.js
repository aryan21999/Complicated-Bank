...
var initRoutes = require("./routes/admin");
...
mongoose.connect('mongodb+srv://Aryan:09876Arya@cluster0.h0l2c.mongodb.net/bank?retryWrites=true&w=majority', function (err, res) {
  if (err) { 
...
app.get("/block", function(req,resp){
	...
	resp.sendFile(__dirname + "/block.html");	
  
  });

app.get("/panel", function(req,resp){
